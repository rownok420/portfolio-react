...
const About = () => {
    useEffect(() => {
        document.title = 'About : Monir Hossain - Personal Porfolio Website'
    }, []);
    return (
        <main>
            <ScrollToTop />
            ...
            <Container>
                <Row>
                        ...
                        <div className="mt-5">
                            <Roll>
                                <div className="d-block text-center">
                                    <img className="img-fluid w-50 pb-3" src={monir} alt="monir" />
                                </div>
                            </Roll>
                            <Bounce left>
                                <h2 className="abril-font">
                                    <small className="text-green">I'm</small>
                                    {" "} Monir Hossain.
                                </h2>
                    ...
                    <Col md={6}>
                        <Bounce right>
                            <div className="my-5">
                                <h4 className="skill-title abril-font text-uppercase mb-3">
                                    My Skills Set
                                </h4>
